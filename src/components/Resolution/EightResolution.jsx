...
const EightResolution = () => {
  ...
  return (
    <>
      ...
      <section className="custom-container flex flex-col items-center md:flex-row    gap-5 relative mt-20 py-6">
         ...
         <h3 className="text-baseColor italic font-semibold text-xl md:text-2xl">
